...
INSERT INTO TAB_CHECK (ID, NOME, IDADE, CIDADE) VALUES (2,'PEDRO', 17, 'SÃO PAULO') --vai dar erro no insert pq não respeita o constraint
...
UPDATE TAB_CHECK2 SET CIDADE = 'SÃO PAULO' WHERE ID = 2  --vai dar erro no update pq não respeita o constraint
